...
const DetailOfPlaces = ({ navigation, route }) => {
  ...
  const getDatabase = async () => {
    try {
      const data = await firestore().collection('Places').doc('IGR0Jnei2cq7ZcJa2aKs').get();

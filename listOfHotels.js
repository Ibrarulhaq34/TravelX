...
export default listOfHotels = ({ navigation }) => {
    ...
    const getDatabase = async () => {
        try {
            const data = await firestore().collection('Hotels').doc('lUXpwCSCiuydGeu7RkCC').get();
    ...
    return (
        <View>
            ...
            <Text style={styles.text}>    Famous Hotels For Visit</Text>
            ...
            <ScrollView style={styles.listView}>
                ...
                <TouchableOpacity
                    onPress={() => navigation.navigate('DetailOfHotel', { name: myData.n1 })}
                    style={styles.btn}
                >
                ...
                <TouchableOpacity
                    onPress={() => navigation.navigate('DetailOfHotel', { name: myData.n2 })}
                    style={styles.btn}
                >
                    <Text style={{ color: '#FFFFFF',fontSize:18 }}>Details</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                    onPress={() => navigation.navigate('DetailOfHotel', { name: myData.n3 })}
                    style={styles.btn}
                >
                    <Text style={{ color: '#FFFFFF' ,fontSize:18}}>Details</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                    onPress={() => navigation.navigate('DetailOfHotel', { name: myData.n4 })}
                    style={styles.btn}
                >
                    <Text style={{ color: '#FFFFFF',fontSize:18 }}>Details</Text>
                </TouchableOpacity>

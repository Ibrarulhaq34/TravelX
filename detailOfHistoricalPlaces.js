...
const DetailOfHistoricalPlaces = ({ navigation, route }) => {
  ...
  const getDatabase = async () => {
    try {
      const data = await firestore().collection('HistoricalPlaces').doc('ygsMblSWxuLb9f0qkKA1').get();
  ...
  return (
    <View>
      <ScrollView style={styles.listView}>
        {route.params?.name === 'Mosque of Mariyam Zamani Begum' ? (
          <>
            <Image
...
export default DetailOfHistoricalPlaces;
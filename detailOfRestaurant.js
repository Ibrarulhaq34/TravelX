...
const DetailOfRestaurant = ({ navigation, route }) => {
  ...
  const getDatabase = async () => {
    try {
      const data = await firestore().collection('Restaurant').doc('xPGK4lspn4T7MJadBrYZ').get();
